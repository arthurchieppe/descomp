...
SIGNAL \decoderGeneric|saida[1]~1_combout\ : std_logic;
SIGNAL \decoderGeneric|saida[2]~2_combout\ : std_logic;
...
SIGNAL \decoderGeneric|saida[0]~0_combout\ : std_logic;
...
SIGNAL \decoderGeneric|ALT_INV_saida[1]~1_combout\ : std_logic;
...
\decoderGeneric|ALT_INV_saida[1]~1_combout\ <= NOT \decoderGeneric|saida[1]~1_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \decoderGeneric|saida[0]~0_combout\,
	devoe => ww_devoe,
	o => ww_LEDR(6));
...
-- pragma translate_on
PORT MAP (
	i => \decoderGeneric|saida[1]~1_combout\,
	devoe => ww_devoe,
	o => ww_LEDR(7));
...
-- pragma translate_on
PORT MAP (
	i => \decoderGeneric|saida[2]~2_combout\,
	devoe => ww_devoe,
	o => ww_LEDR(8));
...
\decoderGeneric|saida[1]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \decoderGeneric|saida[1]~1_combout\ = ( !\PC|DOUT\(0) & ( !\PC|DOUT\(1) & ( !\PC|DOUT[2]~DUPLICATE_q\ ) ) )
...
PORT MAP (
	...
	combout => \decoderGeneric|saida[1]~1_combout\);

-- Location: LABCELL_X1_Y19_N48
\decoderGeneric|saida[2]~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \decoderGeneric|saida[2]~2_combout\ = ( \PC|DOUT[1]~DUPLICATE_q\ & ( \PC|DOUT[0]~DUPLICATE_q\ & ( !\PC|DOUT\(2) ) ) ) # ( !\PC|DOUT[1]~DUPLICATE_q\ & ( \PC|DOUT[0]~DUPLICATE_q\ & ( !\PC|DOUT\(2) ) ) ) # ( \PC|DOUT[1]~DUPLICATE_q\ & ( 
-- !\PC|DOUT[0]~DUPLICATE_q\ & ( !\PC|DOUT\(2) ) ) ) # ( !\PC|DOUT[1]~DUPLICATE_q\ & ( !\PC|DOUT[0]~DUPLICATE_q\ & ( \PC|DOUT\(2) ) ) )
...
PORT MAP (
	...
	dataf => \PC|ALT_INV_DOUT[0]~DUPLICATE_q\,
	combout => \decoderGeneric|saida[2]~2_combout\);
...
PORT MAP (
	...
	clrn => \decoderGeneric|ALT_INV_saida[1]~1_combout\,
	ena => \decoderGeneric|saida[2]~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \REGA|DOUT\(0));
...
\decoderGeneric|saida[0]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \decoderGeneric|saida[0]~0_combout\ = (!\PC|DOUT\(2) & ((\PC|DOUT[0]~DUPLICATE_q\) # (\PC|DOUT[1]~DUPLICATE_q\)))
...
PORT MAP (
	...
	datad => \PC|ALT_INV_DOUT\(2),
	combout => \decoderGeneric|saida[0]~0_combout\);
